...
### Most Popular Categories for Korea
KR_data %>%
#  group_by(category_name) %>%
#  summarise(count = n())%>%
#  arrange(desc(count)) %>%
...
prep_n_pron <- "^(the|a|s|at|to|of|with|in|on|and|i|you|for|is|am|are|my|it|ft|from|your|this|the|up|by|his|off|official|video|2|day|year|we|me|t)$"
...
According to the plot, the most popular words used in the videos overall is year number. Words such as 2017 and 2018 are used more often by the end of and at the beggining of each year. Moreover, in December, wehn Chirstmas is about to come, the word "Christmas" also become very common in video titles. In Feburary, which is the super bowl season, the words super and bowl often appear in the titles. In the beginning of 2018, the word "new" was used commonly, which may due to the new year just begins.
